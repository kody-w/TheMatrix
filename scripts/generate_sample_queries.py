#!/usr/bin/env python3
"""
Generate sample SQL queries for exploring the Matrix data warehouse.

Outputs useful queries for analyzing repository evolution, agent activity,
...
def main():
    """Print sample queries to stdout."""
    print(SAMPLE_QUERIES.strip())
